...
function initModels(sequelize) {
  ...
  account_histories.belongsTo(account, { as: "account", foreignKey: "account_id"});
  account.hasMany(account_histories, { as: "account_histories", foreignKey: "account_id"});
  ...
  hospital_histories.belongsTo(patient, { as: "patient", foreignKey: "patient_id"});
  patient.hasMany(hospital_histories, { as: "hospital_histories", foreignKey: "patient_id"});
  ...
  status_histories.belongsTo(patient, { as: "patient", foreignKey: "patient_id"});
  patient.hasMany(status_histories, { as: "status_histories", foreignKey: "patient_id"});
  transaction_histories.belongsTo(patient, { as: "patient", foreignKey: "patient_id"});
  patient.hasMany(transaction_histories, { as: "transaction_histories", foreignKey: "patient_id"});

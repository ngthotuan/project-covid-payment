    ...
    return {
        init: function () {
                ...
                [
                    {
                        ...
                        lines: {
                            ...
                            fill: true,
                            fillColor: {
                                colors: [{ opacity: 0.25 }, { opacity: 0.25 }],
                            },
                        },
                    ...
                    },
                    {
                        ...
                        lines: {
                            ...
                            fill: true,
                            fillColor: {
                                colors: [{ opacity: 0.15 }, { opacity: 0.15 }],
                            },
                        },
                        points: { show: true, radius: 6 },
                    },
            ...
            $.plot(
                chartStacked,
                [
                    { label: 'Sales', data: dataSales },
                    { label: 'Earnings', data: dataEarnings },
                ],
                {

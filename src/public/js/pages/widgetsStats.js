...
var WidgetsStats = (function () {
    return {
        init: function () {
            ...
            $('#widget-mini-chart-line1').sparkline(
                'html',
                miniChartLineOptions,
            );
            ...
            $('#widget-mini-chart-line2').sparkline(
                'html',
                miniChartLineOptions,
            );
            ...
            $('#widget-mini-chart-line3').sparkline(
                'html',
                miniChartLineOptions,
            );

...
var ReadyChat = (function () {
    ...
    var updateChatHeight = function () {
        ...
        if (windowW < 768) {
            ...
            chatCon.css(
                'height',
                chatHeightSmall * 2 + chatInput.outerHeight(),
            );
    ...
    return {
        init: function () {
            ...
            chatInput.find('form').submit(function (e) {
                ...
                if (chatMsg) {
                    ...
                    chatTalk
                        .find('ul')
                        .append(
                            '<li class="chatui-talk-msg chatui-talk-msg-highlight themed-border animation-expandUp">' +
                    ...
                    chatTalkScroll.animate(
                        { scrollTop: chatTalkScroll[0].scrollHeight },
                        150,
                    );

                    // Reset the message input
                    chatInput.find('#chatui-message').val('');
                }

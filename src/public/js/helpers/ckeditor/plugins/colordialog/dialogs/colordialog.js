...
CKEDITOR.dialog.add('colordialog', function (x) {
    ...
    function y(a) {
        ...
        'td' == a.getName() &&
            ...
            t.getContentElement('picker', 'selectedColor').setValue(c));
    }
    function C(a) {
        a = a.replace(/^#/, '');
        for (var c = 0, b = []; 2 >= c; c++)
        ...
        return (
            '#' +
            (165 <= 0.2126 * b[0] + 0.7152 * b[1] + 0.0722 * b[2]
                ? '000'
                : 'fff')
        );
    }
    function z(a) {
        ...
        'td' == b.getName() &&
            ...
            c ? (e = b) : (A = b),
            c &&
                (b.setStyle('border-color', C(g)),
                b.setStyle('border-style', 'dotted')),

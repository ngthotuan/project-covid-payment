CKEDITOR.dialog.add('scaytDialog', function (f) {
    ...
    f.on('scaytUserDictionaryAction', function (a) {
        var e = SCAYT.prototype.UILib,
            ...
            f;
        void 0 === a.data.error
            ? ((f = c.getLocal('message_success_' + a.data.command + 'Dic')),
    ...
    f.on('scaytUserDictionaryActionError', function (a) {
        ...
        '' === a.data.name
            ? d.setText(c.getLocal('message_info_emptyDic'))
            : ((f = c.getLocal('message_error_' + a.data.command + 'Dic')),
              (f = f.replace('%s', a.data.name)),
              d.setText(f));
        e.css(d.$, { color: 'red' });
    ...
    var l = {
        ...
        onShow: function () {
            ...
            if (0 != f.config.scayt_uiTabs[2]) {
                var a = f.scayt,
                    ...
                    b = this.getContentElement('dictionaries', 'existDic')
                        .getElement()
                        .getParent(),
        ...
        toggleDictionaryButtons: function (a) {
            var e = this.getContentElement('dictionaries', 'existDic')
                    .getElement()
                    .getParent(),
                b = this.getContentElement('dictionaries', 'notExistDic')
                    .getElement()
                    .getParent();
        ...
        getChangedOption: function () {
            ...
            if (1 == f.config.scayt_uiTabs[0])
                for (
                    ...
                    e[b].isChanged() && (a[e[b].id] = e[b].getValue());
            k.isChanged() &&
                (a[k.id] = f.config.scayt_sLang = k.currentLang = k.newLang);
            return a;
        },
        buildRadioInputs: function (a, e) {
            ...
            e === h.getLang() &&
                ...
                c.setAttribute('defaultChecked', 'defaultChecked'));
            return b;
        },
        renderLangList: function (a) {
            ...
            for (h in d)
                k++, this.buildRadioInputs(d[h], h).appendTo(k <= c ? e : a);
        },

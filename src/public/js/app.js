    ...
    var handlePageScroll = function (sElem, sHeightDiff, sSpeed) {
        if (!page.hasClass('disable-menu-autoscroll')) {
            ...
            if (
                ...
                elemScrollToHeight =
                    elemOffsetTop - sHeightDiff > 0
                        ? elemOffsetTop - sHeightDiff
                        : 0;
                ...
                elemScrollToHeight =
                    elemOffsetCon - sHeightDiff > 0
                        ? elemOffsetCon - sHeightDiff
                        : 0;
        ...
        if (mode === 'init') {
            ...
            if (mode === 'toggle-sidebar') {
                ...
                if (
                    ...
                    if (
                        sScroll.length &&
                        sScroll.parent('.slimScrollDiv').length
                    ) {
